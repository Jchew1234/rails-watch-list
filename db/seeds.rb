...
# puts movies["results"][0]['title']
# puts movies["results"][0]['overview']
# puts movies["results"][0]['vote_average']
# puts movies["results"][0]['poster_path'] #"/q6y0Go1tsGEsmtFryDOJo3dEmqu.jpg"
